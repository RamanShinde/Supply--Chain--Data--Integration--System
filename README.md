...
Vendor Performance Supply Chain Dataset  
https://www.kaggle.com/datasets/vivekkumarkamat/vendor-performance-analysis-project

In this project, the vendor, purchase, and sales CSV files were used.  
You can download these datasets from the above Kaggle link and place them inside your project folder to run the complete workflow.
